...
import type { CollectionParam, FileUrlOption, TypedPocketBase } from './CostumTypes';

export const pb = new PocketBase(env.PUBLIC_PB_URL).autoCancellation(false) as TypedPocketBase;

export const getFileUrl = (collectionIdOrCollectionName: CollectionParam, id: string, filename: string, option?: FileUrlOption): string => {
